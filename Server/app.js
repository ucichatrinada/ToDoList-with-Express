...
app.use(express.static(path.join(__dirname, '../Todo/public'))); // Sesuaikan path dengan lokasi frontend Anda

// ** Route untuk halaman utama **
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, '../Todo/public', 'dist/index.html'));
});
